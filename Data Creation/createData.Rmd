...
appData <- read_excel("raw data/V7_Jobs_M-E_Portfolio_Outputs_All_Vismay_CF Plus Keywords_For Visualization_05-17-17.xlsx", sheet = 3, skip = 1) %>% 
        select(1:23, 230:242)
